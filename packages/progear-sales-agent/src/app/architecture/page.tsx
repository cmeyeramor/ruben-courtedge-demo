...
export default function ArchitecturePage() {
      ...
      <header className="bg-black/30 backdrop-blur-md border-b border-white/10">
        <div className="px-6 py-4 flex justify-between items-center">
          <div className="flex items-center space-x-4">
            <Image src="/tec360-header-logo.png" alt="TEC360" width={90} height={62} className="h-10 w-auto" />
            <div>
              <h1 className="text-white text-2xl font-display font-bold">AI PRO SALES</h1>
              <p className="text-gray-400 text-sm">Architecture & Security Overview</p>
            </div>
          </div>
          <Link
            href="/"
            className="px-5 py-2.5 bg-accent hover:bg-primary text-white rounded-xl transition font-semibold shadow-lg"
          >
            Back to Chat
          </Link>
        </div>
            ...
            <div className="bg-gradient-to-b from-gray-50 to-gray-100 rounded-xl p-6">
              ...
              <div className="mb-4">
                ...
                <div className="bg-white border-2 border-gray-200 px-5 py-3 rounded-xl shadow-sm">
                  <div className="text-gray-700 font-medium">"Can we fulfill 1500 units for State University?"</div>
                </div>
              </div>
                ...
                <div className="bg-white rounded-xl border-2 border-green-200 shadow-sm overflow-hidden">
                  ...
                  <div className="p-4 border-b border-gray-100">
                    ...
                    <div className="bg-gray-900 rounded-lg p-3 font-mono text-sm mb-3">
                      ...
                      <div className="text-green-400">GET /api/inventory/stock?product=sku-1042&qty=1500</div>
        ...
        >
          <div className="mt-4 space-y-6">
            ...
            <div className="bg-gray-50 rounded-xl p-5">
              <h3 className="font-display font-semibold text-gray-800 mb-3 text-sm uppercase tracking-wide">LangGraph Workflow</h3>
            ...
            <div className="bg-white rounded-xl p-5 border border-gray-200">
              <h3 className="font-display font-semibold text-gray-800 mb-3 text-sm uppercase tracking-wide">Router Node Output</h3>
  ...
  "sales":     { "needed": true,  "scopes": ["sales:quote"] }
            ...
            {/* Example with Scopes */}
            <div className="bg-white rounded-xl p-5 border border-gray-200">
              <h3 className="font-display font-semibold text-gray-800 mb-3 text-sm uppercase tracking-wide">Example Query → Token Exchange</h3>
              <div className="bg-purple-50 rounded-lg p-3 mb-4 border-l-4 border-purple-500">
                <div className="text-sm text-purple-800 font-mono">
                  "Can we fulfill 1500 units for State University at a bulk discount?"
                </div>
              </div>
        ...
        >
          <div className="mt-4">
            ...
            <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl p-6 mb-6 border border-purple-100">
              <h3 className="font-display font-semibold text-gray-800 text-lg mb-3">The Challenge</h3>
              ...
              <h3 className="font-display font-semibold text-gray-800 text-lg mb-3">Okta's Solution</h3>
        ...
        <div className="text-center text-gray-400 text-sm py-4">
          Ai Pro Sales - Powered by Okta AI Agent Governance
        </div>
      </div>
    </main>
  );
